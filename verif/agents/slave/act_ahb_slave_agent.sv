...
class act_ahb_slave_agent extends uvm_agent;
  ...
  act_ahb_slave_driver     driver_h;
  act_ahb_slave_monitor    monitor_h;
  act_ahb_slave_sequencer  sequencer_h;

  function new(
    string name = "act_ahb_slave_agent",
  ...
  function void build_phase(uvm_phase phase);
    ...
    monitor_h =act_ahb_slave_monitor::type_id::create("monitor_h",this);

    if(cfg_h.is_active == UVM_ACTIVE) begin
      driver_h =act_ahb_slave_driver::type_id::create("driver_h",this);
      sequencer_h =act_ahb_slave_sequencer::type_id::create("sequencer_h",this);
    end
  endfunction
